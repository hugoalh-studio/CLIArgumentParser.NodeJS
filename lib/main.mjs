 ...
 * @param {string[]} [commandLine=process.argv.slice(2)] Command line that need to parse.
 * @returns {{action:string[],fault:string[],flag:string[],option:{[index:string]:string}}} Parse result.
 */
 function commandLineParser(commandLine = process.argv.slice(2)) {
